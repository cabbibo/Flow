...
function Song( flow , title , track ,fromMesh , toMesh , flowParams , particleParams ){
  ...
  this.hoverMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:this.uniforms,
    fragmentShader:fs.hover,
    vertexShader:vs.hover
  ...
  this.neutralMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:this.uniforms,
    fragmentShader:fs.neutral,
    vertexShader:vs.neutral
  ...
  this.fromMesh.material = this.neutralMaterial;
...
Song.prototype.onHoverOver = function(){
  ...
  if( !this.active ){
    this.fromMesh.material = this.hoverMaterial;
