...
function Song( flow , title , track ,fromMesh , toMesh , params ){
...
Song.prototype.setUniforms = function(){

  for( propt  in this.params ){
   
    console.log( this.params[propt] );
    this.flow.flowShader.uniforms[propt].value = this.params[propt].value;
