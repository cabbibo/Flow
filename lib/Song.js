...
function Song( flow , title , track ,fromMesh , toMesh , color ,  flowParams , particleParams ){
  ...
  console.log('MAP');
  console.log(this.titleMesh.material.map);
  ...
  this.titleMesh.scale.multiplyScalar( 5 );
...
Song.prototype.onHoverOver = function(){
  ...
  if( !this.active ){
    ...
    this.modelMaterial.uniforms.power.value = 2;
    this.textMaterial.uniforms.power.value = 2;
