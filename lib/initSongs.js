function initSongs(){
  ...
  var colors = [
    ...
    new THREE.Vector3( 85 , 33 , 115 ).multiplyScalar( 1 / 256 ),
    new THREE.Vector3( 251 , 231 , 33).multiplyScalar( 1 / 256 ),
    new THREE.Vector3( 234 , 30  , 5).multiplyScalar( 1 / 256 ),
    new THREE.Vector3( 224 , 94 , 130).multiplyScalar( 1 / 256 ),
  ...
  
 {
  ...
  },
  {
    ...
    weirdPower:{ type:"f" , value:0 },
    finalDivision:{ type:"f" , value:1 },
    color:{ type:"v3" , value: new THREE.Vector3( 4.5 , 2. , .5 ) },
