function initSongs(){
  ...
  var colors = [
    ...
    new THREE.Vector3( 255 , 20 , 106).multiplyScalar( 1 / 256 ),
    new THREE.Vector3( 232 , 222  , 62).multiplyScalar( 1 / 256 ),
    new THREE.Vector3( 255 , 100  , 20).multiplyScalar( 1 / 256 ),
