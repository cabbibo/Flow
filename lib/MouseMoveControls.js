THREE.MouseMoveControls = function ( object, domElement ) {
      ...
      this.update = function () {
        ...
        if( this.object.position.z > 0 ){
          this.object.position.x += ( ( this.mouse.x * 10 - this.object.position.x ) + this.x ) * this.speed;
          this.object.position.y += ( (this.mouse.y  * 10- this.object.position.y  ) + this.y ) * this.speed;
        }else{
